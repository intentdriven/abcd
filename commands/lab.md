---
name: lab
description: Run a lab — a throwaway world pinned at one commit of this repository, run to answer one question — by invoking the abcd binary. Mint it, preflight it, scaffold probe records, sweep retractions and assemble the harvest; evidence stays in the machine-scoped lab store and nothing is written into the repository.
---
