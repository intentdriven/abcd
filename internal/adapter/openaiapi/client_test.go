...
// json_encode), '<', '>', '&' and the apostrophe (Go's HTML-safe JSON and
// HTML), '"' and '\\' (every JSON encoder and Go's %q), '+' and ' ' (a URL's
// query) and a non-ASCII letter (\u escapes and QuoteToASCII). A throwaway
