...
wontfix_reason: "the resolved iss-2609012202237613 keeps the strict up-to-date rule, and the queue-only alternative was declined on 2026-09-01 (DECISIONS)"
---
...
- declined: the strict rule stays and the branch update is automated instead; this would be wrong if that 2026-09-01 ruling were reversed
