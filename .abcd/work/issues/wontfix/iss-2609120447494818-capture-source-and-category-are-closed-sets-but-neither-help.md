...
wontfix_reason: "duplicate of iss-2608290810037524: the same closed-set flags on capture (--source, --category) whose refusal and help name no accepted values; both the refusal (acceptedValues in internal/core/capture/validate.go) and capture --help enumerate the accepted values at tip; the residual (name the flag, stop blaming frontmatter) is carried by the survivor"
---
