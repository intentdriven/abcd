...
wontfix_reason: "DECISIONS 2026-09-09 parks every triage grounds refusal (resolved iss-2609091009111294), superseding the 2026-08-31 ruling for a forward-only terminal-record gate"
---
...
- declined: the grounds gates are parked as advisory until the reading work is rethought, so no terminal-record grounds gate will be armed; this would be wrong if that parking were lifted and the forward-only gate re-ruled
