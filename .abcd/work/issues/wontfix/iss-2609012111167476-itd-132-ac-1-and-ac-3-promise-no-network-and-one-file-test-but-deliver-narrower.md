...
wontfix_reason: "adr-46 decision 3 deliberately keeps one online checksum fetch and the cache-mode stat; the wording of itd-132's shipped criteria is historical, not a defect"
---
...
- declined: the narrower reading is the design adr-46 records; this would be wrong if the online checksum fetch or the cache-mode stat were found unnecessary to authenticate the cache
