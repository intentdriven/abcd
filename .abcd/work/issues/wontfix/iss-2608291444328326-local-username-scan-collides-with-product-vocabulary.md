...
wontfix_reason: "duplicate of iss-236: the same local_username false positive, where the launch payload hard-fails on an account name that is also an ordinary product word; the fix (a floor for too-common or short names, and naming the identity source) is carried there"
---
...
- declined: the finding is carried whole by iss-236; this would be wrong if iss-236 were closed without answering it
