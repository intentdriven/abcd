...
wontfix_reason: "deliberate: the resolved iss-2608311518250688 made a definition-load failure a durable refusal; recorded as a consequence, not a defect"
---
...
- declined: a durable refusal is the chosen trade so a refused run is always findable; this would be wrong if a transient load failure could not be recovered by re-assembling under a new run id
