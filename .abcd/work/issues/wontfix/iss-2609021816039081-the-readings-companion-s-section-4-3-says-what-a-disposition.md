...
wontfix_reason: "DECISIONS 2026-09-09 parks the grounds gates as advisory until the reading work is rethought, so no new state-keyed grounds refusal is added"
---
...
- declined: a state-keyed grounds lint would be a new refusal inside the parked gates; this would be wrong if the rethink of the reading work re-arms grounds refusals
