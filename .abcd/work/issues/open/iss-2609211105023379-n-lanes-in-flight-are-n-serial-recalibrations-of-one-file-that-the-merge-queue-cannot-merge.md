...
deferral_reason: "Ruled by the product thinker at the 2026-09-23 run A interview (M33: plan next cycle with its sibling iss-2609210748032488: calibration moves from each lane to one post-merge or queue-side step)."
---
