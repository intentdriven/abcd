...
deferral_reason: "ruling owed to the product thinker (away; run A 2026-09-25): Where does the once-per-merge calibration run: a merge-queue job or a post-merge step on main?"
---
