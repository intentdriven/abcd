...
deferral_reason: "ruling owed to the product thinker (away; run A 2026-09-25): Is a home-directory git toplevel a legitimate config scope (spc-23's user layer), or excluded outright?"
---
