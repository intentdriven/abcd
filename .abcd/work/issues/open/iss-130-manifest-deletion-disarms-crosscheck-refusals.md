...
deferral_reason: "ruling owed to the product thinker (away; run A 2026-09-25): Sign off a release.yml step that refuses a release after v0.4.0 that carries no release-gate manifest?"
---
