...
deferral_reason: "Ruled by the product thinker at the 2026-09-23 run A interview (M9: widen and add detectors; the principle paragraph is written (enforcement-claims-are-facts, 2026-09-23) and the detectors for the class need planning (itd-147 already cites the class); the adjacent sampling case is not admitted)."
---
