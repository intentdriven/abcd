...
deferral_reason: "Routed to the product thinker by the 2026-09-23 run (decision owed: rule bodies escaped, fenced, or left as the host parser contract defines them). The 2026-09-23 interview gave routed minor and nitpick captures the default: deferred past v0.9.0, returning at the next anchor."
---
