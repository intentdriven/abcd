...
deferral_reason: "Ruled by the product thinker at the 2026-09-23 run A interview (M5: ship by hand each pre-ceremony delivery (itd-85, the delivered part of itd-60, and the three intent-less capabilities), with a note that it was delivered before the ceremony existed. Not applied by the run: shipped/ requires a spec, and a draft's planning is never run unattended; itd-60 is also a queued lane)."
---
