...
deferral_reason: "Routed to the product thinker by the 2026-09-23 run (ruling owed: structural PDF Author/EXIF reading vs an accepted false-positive rate for short single-token names on bytes). The 2026-09-23 interview gave routed minor and nitpick captures the default: deferred past v0.9.0, returning at the next anchor."
---
