...
deferral_reason: "Ruled by the product thinker at the 2026-09-23 run A interview (M15: plan next cycle with stale closures included: every terminal transition gets a changelog line (principles and ADRs too, internal no longer silenced), including issues closed with no fixing commit)."
---
