...
deferral_reason: "ruling owed to the product thinker (away; run A 2026-09-25): Plan the read-only check of the host's branch-build setting under itd-2609221017023290's credential model, or close on the comment alone?"
---
