...
resolution: "spc-11 records the supersession of itd-67's fourth criterion (the tier derives from record impact) and adr-2609212115255771 retires phases; the intent text awaits the errata convention"
impact: internal
---
...
- pursued: the delivered behaviour is the recorded one and the supersession is findable from the spec; shown wrong if spc-11's Reconciliations stop naming the bump-tier supersession
