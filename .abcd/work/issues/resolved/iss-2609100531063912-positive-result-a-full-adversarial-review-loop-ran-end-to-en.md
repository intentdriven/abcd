...
resolution: "positive evidence only: the record shapes held under an unattended review loop, bounding iss-2609100509531349; nothing to decide"
impact: internal
---
...
- pursued: the record shapes absorb an adversarial review loop without change; shown wrong if a later unattended loop needs a record shape the ledger cannot express
