...
resolution: "scribe ingest judges the readings directory and the run directory with readingitem.RefuseSymlinkedDir before listing, after capture.RefuseRedirectedLedger judges the ancestors"
impact: fix
resolved_by:
  commit: "3edb3683"
---
...
- pursued: TestScribeIngestRefusesASymlinkedReadingsOrRunDir plants a resolving link at each directory after assembly and expects ErrSymlink; an ingest that lists through either link would show it wrong
