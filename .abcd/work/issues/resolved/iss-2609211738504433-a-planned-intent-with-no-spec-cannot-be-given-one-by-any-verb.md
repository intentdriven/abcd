...
resolution: "intent plan on a planned record whose spec_id is null mints (or reuses) and links the spec in place, on the draft's Acceptance Criteria bar, with no bucket move; the readiness gate's remedy names that call."
impact: additive
resolved_by:
  commit: "86f59ea524c52e6cd8869cf22946090e9b0cac20"
---
...
- pursued: the fourteen planned intents with spec_id null can each be given a spec by one verb; a planned null-spec record that plan refuses, or a remedy that still names a hand-authored spec, would show it wrong
