...
resolution: "itd-195 (a discipline adopted 2026-08-31) decides that an enumeration is made executable or deleted; the grounds vocabulary copies are now derived (UsageSpelling and ProseList in internal/core/grounds)"
impact: internal
resolved_by:
  intent: "itd-195"
---
...
- pursued: the vocabulary is spelt from one derivation rather than enumerated in prose; shown wrong if a hand-spelt copy of the vocabulary drifts from internal/core/grounds
