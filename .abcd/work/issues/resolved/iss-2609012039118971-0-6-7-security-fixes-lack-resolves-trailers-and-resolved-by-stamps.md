...
resolution: "RS001 to RS003 are armed by the resolved iss-2608241347321757 in lint-issues, preflight and CI; the two advisories are bound by their ledger markers"
impact: internal
---
...
- pursued: the resolution gates now fire on every branch that runs preflight or CI; shown wrong if a record reaches resolved/ with a Resolves trailer mismatch that lint-issues does not refuse
