...
resolution: "spc-10 sets the impact bar at shipped/ (AGENTS.md: shipped/ requires one, with no default); a draft legitimately carries none until the close"
impact: internal
---
...
- pursued: an absent impact is a blocker only where the spec puts the bar; shown wrong if a record reaches shipped/ with no impact
