...
resolution: "ReadDeclaration confirms with os.SameFile that the opened descriptor is the file its lstat vetted, refusing a replacement as DeclarationUnreadable (ErrDeclarationSwapped)."
impact: fix
resolved_by:
  commit: "40f000b4"
---
...
- pursued: every home-scoped declaration read refuses a file renamed into place between the vetting lstat and the open; TestReadDeclarationRefusesAFileSwappedInAfterVetting would show it wrong by reading the swapped bytes
