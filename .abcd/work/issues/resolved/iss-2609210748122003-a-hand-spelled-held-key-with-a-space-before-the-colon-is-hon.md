...
resolution: "The scanner exposes a key spelled with whitespace before its colon, and record_provenance reports it for held and the disclosure pair."
impact: fix
resolved_by:
  commit: "f5366f58"
---
...
- pursued: a held or disclosure key spelled with a space or tab before its colon is reported while the verbs' own spelling is silent; a spaced key passing lint would show it wrong
