...
resolution: "the v0.10.0 gate ran the full-tier cross-check, and itd-147's Audit Notes record the sixth criterion chapter by chapter (not met, iss-2609240519422232); the release-gate README's owed paragraph was dropped in the same change (0a8d8c38)"
impact: internal
resolved_by:
  commit: "0a8d8c38b3b5304fe7cfe0a171513e0c11271080"
---
...
- pursued: the outcome check has a ledger record and nothing asks for it any more; shown wrong if itd-147's Audit Notes lose the outcome check or the owed paragraph returns
