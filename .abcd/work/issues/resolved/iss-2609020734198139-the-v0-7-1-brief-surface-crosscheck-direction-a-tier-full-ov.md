...
resolution: "already fixed at tip: the 01-ahoy SessionEnd exception (958187d5), ahoy status named as an unknown command, and the 07-memory spc-38 note and gate list corrected in the batch C and D brief sweeps"
impact: internal
resolved_by:
  commit: "958187d53391e61d380ad6fd28e4bf5843388b9a"
---
...
- pursued: the four false claims are gone from the brief; shown wrong if any of the four reappears in 01-ahoy.md or 07-memory.md
