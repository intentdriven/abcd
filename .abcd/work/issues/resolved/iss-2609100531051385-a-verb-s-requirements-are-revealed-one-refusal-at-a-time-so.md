...
resolution: "For a verb whose Use line declares a required flag, a refusal with wrong positionals or more than one unmet requirement names every unmet requirement and the usage line at once; a single missing flag keeps the verb's own refusal."
impact: fix
resolved_by:
  commit: "816827bce81d0263cf55b3004d51dbb22ea71c06"
---
...
- pursued: a caller learns every requirement a verb declares from its first refusal; a positional refusal that omits a missing required flag, or two unmet flags refused one at a time, would show it wrong
