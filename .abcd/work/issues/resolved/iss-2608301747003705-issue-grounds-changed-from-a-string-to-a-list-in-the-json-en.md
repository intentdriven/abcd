...
resolution: "shipped: the list-shaped grounds envelope released with itd-179's append-only grounds, and no consumer bound the string shape; nothing is left to decide"
impact: internal
resolved_by:
  intent: "itd-179"
---
...
- pursued: the shape change is findable and broke no released consumer; shown wrong if an external consumer is found bound to the string-shaped Grounds field
