...
| [bundle](core/bundle.md) | stable | Several intents that share one spec because they ship as one change. |
| [milestone](core/milestone.md) | superseded | A planned end condition; retired in favour of the derived release and each intent's criteria. |
| [record-families](core/record-families.md) | stable | The one page that maps the record families and how they relate. |
| [step](core/step.md) | stable | One landable piece of a spec, listed under its Steps section. |
