...
- `itd-2609231434459890` — abcd's own test lanes check the machine's load before they start and refuse when it is too high, naming what is running (the fourth condition of the load-experiment trust rule; the other three ship in the bundled `LOAD` rule domain)
<!-- /index -->
