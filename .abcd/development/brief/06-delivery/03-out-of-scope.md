...
- `itd-2609231013154443` — each release carries a press release composed at the cut from its shipped intents' press releases, written beside the changelog, backward-looking with no forecast (the successor adr-2609212115255771 names to the phase Expectation; `builds_on` itd-67 and itd-73; awaiting its planning interview)
<!-- /index -->
