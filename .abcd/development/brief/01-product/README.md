...
`03-mental-model.md` first — the brief / intent / spec distinction, with the
spec's steps, the bundle and the derived release beside it, underpins every other
section of the brief.

| # | File | Role |
|---|---|---|
| 1 | [`01-press-release.md`](01-press-release.md) | Working-backwards press release — what abcd does, in the user's words |
| 2 | [`02-context.md`](02-context.md) | Where the product came from: the manual-lifeboat origin and the problem it automates |
| 3 | [`03-mental-model.md`](03-mental-model.md) | The three layers (brief / intent / spec, then steps), the bundle and the derived release that organise all development work |
