...
- **Acceptance criterion 5 (the missing half).** The brief's mental-model chapter reads brief, intent, spec (then steps) with the bundle and the derived release named. At closure `brief/01-product/03-mental-model.md:5` still describes four layers with phase.
