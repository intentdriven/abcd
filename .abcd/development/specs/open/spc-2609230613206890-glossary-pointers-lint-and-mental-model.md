...
- **Acceptance criterion 5 (the missing half).** The brief's mental-model chapter reads brief, intent, spec (then steps) with the bundle and the derived release named. At closure the opening paragraph of the brief's [Four-Layer Mental Model](../../brief/01-product/03-mental-model.md#four-layer-mental-model) chapter still describes four layers with phase.
